        ...
        blogs_list = [
            {
                ...
                "category": json.loads(blog['blog']).get('blogCategory', 'General'),
                "slug": blog['slug'],
                "type": blog['type'],
    ...
    try:
        ...
        return {
            ...
            "blog": {
                ...
                "category": json.loads(new_blog['blog']).get('blogCategory', 'General'),
                "slug": new_blog['slug'],
                "type": new_blog['type'],
    ...
    try:
        ...
        return {
            ...
            "blog": {
                ...
                "category": json.loads(updated_blog['blog']).get('blogCategory', 'General'),
